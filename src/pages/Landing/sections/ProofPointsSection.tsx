  ...
  return (
    <section className="py-24 bg-neutral-950 relative border-t border-neutral-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <StaggerRevealContainer className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {PROOF_POINTS.map((point, index) => (
            <StaggerRevealItem key={index} className="h-full">
              <HoverCard className="p-8 h-full flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-2xl bg-neutral-800/50 flex items-center justify-center mb-6">
                  {point.icon}
                </div>
