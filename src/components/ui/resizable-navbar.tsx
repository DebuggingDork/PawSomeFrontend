...
export const NavbarButton = ({
  ...
  const baseStyles =
    "px-6 py-2 rounded-full text-sm font-semibold relative cursor-pointer hoverable:hover:-translate-y-0.5 transition-all duration-200 inline-flex items-center justify-center";
